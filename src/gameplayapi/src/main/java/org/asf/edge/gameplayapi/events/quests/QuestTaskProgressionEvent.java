...
/**
 * 
 * Quest progression event - called when quest tasks are being done
 * 
 * @author Sky Swimmer
 *
 */
@EventPath("quests.questmanager.quest.task.progress")
public class QuestTaskProgressionEvent extends GameplayApiServerEvent {
	...
	public QuestTaskProgressionEvent(UserQuestInfo quest, MissionData.TaskBlock task, String payload,
	...
	public String eventPath() {
		return "quests.questmanager.quest.task.progress";
	}
