...
/**
 * 
 * Quest completion event - called when quests are completed
 * 
 * @author Sky Swimmer
 *
 */
@EventPath("quests.questmanager.quest.completed")
public class QuestCompletedEvent extends GameplayApiServerEvent {

	private UserQuestInfo quest;
	private AccountSaveContainer save;
	private QuestManager questManager;

	public QuestCompletedEvent(UserQuestInfo quest, AccountSaveContainer save, QuestManager questManager) {
		this.quest = quest;
		this.save = save;
	...
	public String eventPath() {
		return "quests.questmanager.quest.completed";
	}
