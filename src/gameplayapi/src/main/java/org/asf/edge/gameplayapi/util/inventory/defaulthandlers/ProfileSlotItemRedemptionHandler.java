...
public class ProfileSlotItemRedemptionHandler extends AbstractItemRedemptionHandler {

	@Override
	public boolean canHandle(ItemInfo item) {
		return item.getID() == 7971;
	}
	...
	public RedemptionResult handleRedemption(ItemInfo item, ItemRedemptionInfo req, AccountObject account,
		...
		PlayerInventoryContainer cont = account.getInventory().getContainer(req.containerID);
