...
public class DatabaseCommonKvDataContainer extends CommonKvDataContainer {

	private String table;
	private DatabaseCommonDataManager mgr;
	private Logger logger = LogManager.getLogger("CommonDataManager");

	public DatabaseCommonKvDataContainer(DatabaseCommonDataManager mgr, String table) {
		this.mgr = mgr;
		this.table = table;
	}
