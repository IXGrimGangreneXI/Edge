...
public class CommonIndexPage {
	...
	public static void index(File requestedFile, HttpRequest request, HttpResponse response) {
		try {
			...
			InputStream strm = CommonIndexPage.class.getResource("/index.template.html").openStream();
	...
	private static String processIndex(String str, String path, String name, File data, File[] directories,
			File[] files) {
