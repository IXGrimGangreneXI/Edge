 ...
 * 
 * @deprecated Use {@link LegacyFunctionInfo} instead with the updated API
 *             format
 * @author Sky Swimmer
 *
 */
@Deprecated
public class LegacyFunctionInfo {
	...
	public LegacyFunctionInfo(String path, HttpRequest request, HttpResponse response, ConnectiveHttpServer server,
