...
public abstract class AccountKvDataContainer {
	 ...
	 */
	public AccountKvDataContainer getParent() {
		return parent;
	}
	 ...
	 */
	public AccountKvDataContainer getChildContainer(String key) throws IOException {
		// Verify name
		if (!validName(key))
			throw new IOException("Invalid key");
	...
	private class ChildDataContainer extends AccountKvDataContainer {

		private boolean inited = false;

		public ChildDataContainer(String path, String name, AccountKvDataContainer parent) {
			this.path = path;
			this.parent = parent;
			this.name = name;
		}
