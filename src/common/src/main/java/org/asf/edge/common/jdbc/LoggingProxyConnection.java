...
public class LoggingProxyConnection implements Connection {

	private Connection target;

	public LoggingProxyConnection(Connection target) {
		this.target = target;
	}
	...
	public CallableStatement prepareCall(String arg0) throws SQLException {
		LogManager.getLogger("DATABASE").debug("Database query: " + arg0);
