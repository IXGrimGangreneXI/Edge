...
public class GenerateMasterTokenCommand implements IGridServerCommand {

	@Override
	public String id() {
		return "genmastertoken";
	}
	...
	public String description(CommandContext ctx) {
		return "Generates a API master token";
	}
	...
	public String run(String[] args, CommandContext ctx, Logger logger, Consumer<String> outputWriteLineCallback,
		...
		return "Token generated: " + token.toTokenString()
				+ "\n\nWARNING: DO NOT SHARE THIS TOKEN, IT GRANTS FULL ACCESS TO THE GRID API.";
	}
