...
/**
 * 
 * Room creation event - called when rooms are created
 * 
 * @author Sky Swimmer
 *
 */
@EventPath("rooms.create")
public class RoomCreatedEvent extends EventObject {
	...
	public RoomCreatedEvent(ZoneManager zoneManager, GameZone zone, RoomGroup group, RoomInfo room) {
