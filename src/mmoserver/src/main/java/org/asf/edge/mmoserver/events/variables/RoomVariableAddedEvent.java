...
/**
 * 
 * Room variable added event - called when variables are added to rooms
 * 
 * @author Sky Swimmer
 *
 */
@EventPath("rooms.variables.added")
public class RoomVariableAddedEvent extends EventObject {
	...
	public String eventPath() {
		return "rooms.variables.added";
	}

	public RoomVariableAddedEvent(ZoneManager zoneManager, GameZone zone, RoomGroup group, RoomInfo room,
